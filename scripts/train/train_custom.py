...
parser.add_argument("--train_path", type=str, default='../../data/kinfotabs_withrels/train_with_lstmrels.csv', help='train csv/tsv file with generated relations')
parser.add_argument("--val_path", type=str, default='../../data/kinfotabs_withrels/dev_with_lstmrels.csv', help='development csv/tsv file with generated relations')
...
dfs = [pd.read_csv(args.train_path), pd.read_csv(args.val_path)]
...
print("  Percent: ", args.Data_percent, "  Seed: ", args.seed, "  Add_Knowledge: ", args.addkb)
